...
class BuySheet extends StatefulWidget {
  ...
  const BuySheet(
      {super.key, this.applePayEnabled,
      this.googlePayEnabled,
      this.applePayMerchantId,
      this.squareLocationId, required this.onComplete});
...
class BuySheetState extends State<BuySheet> {
  ...
  void _showUrlNotSetAndPrintCurlCommand(String nonce,
    ...
    Fluttertoast.showToast(
        ...
        fontSize: 16.0);
    // TODO: set backend for effective payments
    /*
    showAlertDialog(
        ...
        home: Scaffold(
          ...
          body: Builder(
            builder: (context) => Center(
              ...
              children: [
                const Image(width: 100, image: AssetImage("assets/iconKYC.png")),
                const Text(
                  'Pay for your KYC',
                  style: TextStyle(
                    fontSize: 28,
